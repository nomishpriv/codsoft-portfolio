    ...
    <section className=" sm:px-8 pt-[80px]" id="contact">
      ...
      <div className="grid md:grid-cols-2 mt-4 md:mt-10 py-12 gap-4 relative">
        ...
        >
          ...
          <div className="flex flex-row gap-5 mt-6">
            <a
              href="https://github.com/nomishpriv"
            ...
            <a
              href="https://www.linkedin.com/in/noman-khann/"
              className="relative group hover:-translate-y-[2px] transition-all duration-500 ease-in-out "
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://twitter.com/Pakhhtoonishere"
              className="relative group hover:-translate-y-[2px] transition-all duration-500 ease-in-out "
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          {show && (
            <div className="mt-6 w-[80%]">
              <p className="text-md text-textPara text-left">
                Thank you for getting in touch! I value your inquiry and will
                respond promptly. Meanwhile, please feel free to explore more of
                my portfolio.
              </p>
            </div>
          )}
      ...
      <footer className="flex items-center p-6 text-center">
        <span className="w-full text-textPara">
          All Rights Reserved © {new Date().getFullYear()} - Noman Khan
        </span>
      </footer>
    </section>
  );
