      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 py-6 place-items-center">
        ...
        >
          <p className="text-textWhite p-4 text-lg sm:text-xl sm:leading-8">
            I am a devoted MERN Stack Developer and Solution Seeker, committed
            to crafting influential code that flourishes on the web.
            <br />
            My expertise encompasses JavaScript, HTML, CSS, React.js,
            Node.js, Express.js, MongoDB, Tailwind CSS, and Git.
            <br />I am an avid learner, continuously striving to broaden my
